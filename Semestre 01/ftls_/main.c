...
/*   Updated: 2013/12/15 07:11:57 by adebray          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
struct dirent	**load_basic_dir(char *dir)
{
	int				len;
	struct dirent	**read;
...
void	treat_plague(int argc, char** argv, int i)
{
	int		j;
	int		k;
	struct dirent	***save;
